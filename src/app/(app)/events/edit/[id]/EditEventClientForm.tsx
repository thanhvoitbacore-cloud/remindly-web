...
export default function EditEventClientForm({ eventId, initialData }: EditFormProps) {
    ...
    return (
        <form action={handleUpdate} className="space-y-8 bg-gray-900 border border-gray-800 rounded-2xl p-6 md:p-8 shadow-xl">
                ...
                <div>
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            required
                            className="w-full bg-gray-950 border border-gray-800 text-white rounded-xl pl-10 pr-4 py-3 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all placeholder:text-gray-600"
                ...
                <div>
                    ...
                    <div className="relative">
                        ...
                        <textarea
                            ...
                            rows={4}
                            className="w-full bg-gray-950 border border-gray-800 text-white rounded-xl pl-10 pr-4 py-3 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all placeholder:text-gray-600 resize-none"
                ...
                <div>
                    ...
                    <div className="relative">
                        ...
                        <select
                            ...
                            className="w-full bg-gray-950 border border-gray-800 text-white rounded-xl pl-10 pr-4 py-3 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all appearance-none"
                        >
            ...
            {/* Thời gian Setup */}
            <div className="bg-gray-950/50 rounded-2xl p-6 border border-gray-800 space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input
                            ...
                            required
                            className="w-full bg-gray-900 border border-gray-800 text-white rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all"
                        />
                    </div>
                    <div>
