    ...
    return (
        <div className="max-w-7xl mx-auto space-y-space-8 animate-in fade-in duration-500">
            <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-space-4 pb-space-6 border-b border-gray-800">
                <div>
                    <h1 className="h1-premium text-white mb-space-2">Draft Drawer</h1>
                    <p className="body-premium text-gray-400">Manage unfinished events. Drafts are automatically purged 30 days after their last modification.</p>
                </div>
            ...
            {drafts.length === 0 ? (
                <div className="p-space-12 text-center rounded-2xl bg-gray-900 border border-gray-800 flex flex-col items-center justify-center">
                    <PenLine className="w-12 h-12 text-gray-700 mb-space-4" />
                    <h3 className="h2-premium text-gray-300">Your draft drawer is empty</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-space-4">
                    {drafts.map(draft => (
                        <div key={draft.id} className="p-space-6 rounded-2xl bg-gray-900 border border-gray-800 flex flex-col justify-between group h-full relative overflow-hidden">
                            <div className="absolute top-0 right-0 p-space-4 opacity-5 pointer-events-none">
                                <AlertTriangle className="w-24 h-24" />
                            </div>
                            <div>
                                <h3 className="h3-premium text-white group-hover:text-indigo-400 transition mb-space-2">
                                ...
                                {draft.description && (
                                    <p className="body-premium text-gray-400 line-clamp-3 mb-space-6">
                                        {draft.description}
                                    </p>
                                )}
                            </div>

                            <div className="space-y-space-4 pt-space-4 border-t border-gray-800">
                                <div className="flex items-center justify-between caption-premium text-gray-500">
